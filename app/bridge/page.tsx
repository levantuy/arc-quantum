  ...
  return (
    <div className="min-h-screen bg-gray-50 dark:bg-transparent p-6">
      <div className="max-w-7xl mx-auto">
        <div className="mb-8">
          <h2 className="text-3xl font-bold text-gray-900 dark:text-gray-100">Bridge</h2>
        ...
        <div className="mb-6 border-b border-gray-200 dark:border-gray-700">
          <div className="flex gap-4">
            ...
            <button
              ...
              className="px-4 py-2 font-semibold border-b-2 border-transparent text-gray-600 dark:text-gray-400 hover:text-gray-800 dark:hover:text-gray-200 transition"
            >
              History & Status
            </button>
          </div>
        ...
        <div className="space-y-6">
          {selectedTransactionId === null ? (
            ...
            <div className="grid grid-cols-1 lg:grid-cols-5 gap-6">
              ...
              <div className="lg:col-span-3 p-6 bg-blue-50 dark:bg-blue-950/30 border border-blue-200 dark:border-blue-800 rounded-lg">
                <h3 className="font-semibold text-blue-900 dark:text-blue-200 mb-3">How to Bridge</h3>
          ...
          <div className="mt-12">
            <h2 className="text-2xl font-bold dark:text-gray-100 mb-6">Transaction History</h2>
            <BridgeHistory
